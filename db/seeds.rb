...
forty_five = Post.create(author_id:5 , title: 'Hello, Luke', text: 'This is my fifth post')
forty_six = Post.create(author_id:6 , title: 'Hello, Kennedy', text: 'This is my sixth post')
forty_seven = Post.create(author_id:7 , title: 'Hello, John', text: 'This is my seventh post')
forty_eight = Post.create(author_id:8 , title: 'Hello, Sophie', text: 'This is my eighth post')
forty_nine = Post.create(author_id:9 , title: 'Hello, Banda', text: 'This is my tenth post')
fifty = Post.create(author_id:10 , title: 'Hello, Ben', text: 'This is my eleventh post')
fifty_one = Post.create(author_id:11 , title: 'Hello, Benjamin', text: 'This is my twelfth post')
fifty_two = Post.create(author_id:12 , title: 'Hello, Dad', text: 'This is my thirteenth post')
fifty_three = Post.create(author_id:13 , title: 'Hello, Mom', text: 'This is my fourteenth post')
fifty_four = Post.create(author_id:14 , title: 'Hello, Aunt', text: 'This is my fifteenth post')
fifty_five = Post.create(author_id:15 , title: 'Hello, Uncle', text: 'This is my sixteenth post')
fifty_six = Post.create(author_id:1 , title: 'Hello, Cousin', text: 'This is my seventeenth post')
fifty_seven = Post.create(author_id:7 , title: 'Hello, Cousin', text: 'This is my eighteenth post')
fifty_eight = Post.create(author_id:8 , title: 'Hello, Cousin', text: 'This is my nineteenth post')
fifty_nine = Post.create(author_id:9 , title: 'Hello, Cousin', text: 'This is my twentieth post')
sixty = Post.create(author_id:10 , title: 'Hello, Mwansa', text: 'This is my first post')
sixty_one = Post.create(author_id:11 , title: 'Hello, Linda ', text: 'This is my second post')
sixty_two = Post.create(author_id:12 , title: 'Hello, Linda ', text: 'This is my third post')
sixty_three = Post.create(author_id:13 , title: 'Hello, Lilly', text: 'This is my fourth post')
sixty_four = Post.create(author_id:14 , title: 'Hello, Luke', text: 'This is my fifth post')
sixty_five = Post.create(author_id:15 , title: 'Hello, Kennedy', text: 'This is my sixth post')
sixty_six = Post.create(author_id:1 , title: 'Hello, John', text: 'This is my seventh post')
sixty_seven = Post.create(author_id:7 , title: 'Hello, Sophie', text: 'This is my eighth post')
sixty_eight = Post.create(author_id:8 , title: 'Hello, Banda', text: 'This is my tenth post')
sixty_nine = Post.create(author_id:9 , title: 'Hello, Ben', text: 'This is my eleventh post')
seventy = Post.create(author_id:10 , title: 'Hello, Benjamin', text: 'This is my twelfth post')
seventy_one = Post.create(author_id:11 , title: 'Hello, Dad', text: 'This is my thirteenth post')
...
Comment.create(post: twenty_eighth, author_id: 6, text: 'I enjoy twenty twenty twenty eighth post' )
Comment.create(post: thirty, author_id: 6, text: 'I enjoy twenty twenty twenty ninth post' )
Comment.create(post: thirty_one, author_id: 6, text: 'I enjoy twenty twenty twenty tenth post' )
Comment.create(post: thirty_two, author_id: 6, text: 'I enjoy twenty twenty twenty eleventh post' )
Comment.create(post: thirty_three, author_id: 6, text: 'I enjoy twenty twenty twenty twelfth post' )
Comment.create(post: thirty_four, author_id: 7, text: 'I enjoy twenty twenty twenty thirteenth post' )
Comment.create(post: thirty_five, author_id: 7, text: 'I enjoy twenty twenty twenty fourteenth post' )
Comment.create(post: thirty_six, author_id: 7, text: 'I enjoy twenty twenty twenty fifteenth post' )
Comment.create(post: thirty_seven, author_id: 7, text: 'I enjoy twenty twenty twenty sixteenth post' )
Comment.create(post: thirty_eight, author_id: 7, text: 'I enjoy twenty twenty twenty seventeenth post' )
Comment.create(post: thirty_nine, author_id: 8, text: 'I enjoy twenty twenty twenty eighteenth post' )
Comment.create(post: forty, author_id: 8, text: 'I enjoy twenty twenty twenty nineteenth post' )
Comment.create(post: forty_one, author_id: 8, text: 'I enjoy twenty twenty twenty twentieth post' )
Comment.create(post: forty_two, author_id: 8, text: 'I enjoy twenty twenty twenty twenty first post' )
Comment.create(post: forty_three, author_id: 8, text: 'I enjoy twenty twenty twenty twenty second post' )
Comment.create(post: forty_four, author_id: 9, text: 'I enjoy twenty twenty twenty twenty third post' )
Comment.create(post: forty_five, author_id: 9, text: 'I enjoy twenty twenty twenty twenty fourth post' )
Comment.create(post: forty_six, author_id: 9, text: 'I enjoy twenty twenty twenty twenty fifth post' )
Comment.create(post: forty_seven, author_id: 9, text: 'I enjoy twenty twenty twenty twenty sixth post' )
Comment.create(post: forty_eight, author_id: 9, text: 'I enjoy twenty twenty twenty twenty seventh post' )
Comment.create(post: forty_nine, author_id: 2, text: 'I enjoy twenty twenty twenty twenty eighth post' )
Comment.create(post: fifty, author_id: 2, text: 'I enjoy twenty twenty twenty twenty ninth post' )
Comment.create(post: fifty_one, author_id: 2, text: 'I enjoy twenty twenty twenty twenty tenth post' )
Comment.create(post: fifty_two, author_id: 2, text: 'I enjoy twenty twenty twenty twenty eleventh post' )
Comment.create(post: fifty_three, author_id: 2, text: 'I enjoy twenty twenty twenty twenty twelfth post' )
Comment.create(post: fifty_four, author_id: 1, text: 'I enjoy twenty twenty twenty twenty thirteenth post' )
Comment.create(post: fifty_five, author_id: 1, text: 'I enjoy twenty twenty twenty twenty fourteenth post' )
Comment.create(post: fifty_six, author_id: 1, text: 'I enjoy twenty twenty twenty twenty fifteenth post' )
Comment.create(post: fifty_seven, author_id: 1, text: 'I enjoy twenty twenty twenty twenty sixteenth post' )
Comment.create(post: fifty_eight, author_id: 1, text: 'I enjoy twenty twenty twenty twenty seventeenth post' )
Comment.create(post: fifty_nine, author_id: 3, text: 'I enjoy twenty twenty twenty twenty eighteenth post' )
Comment.create(post: sixty, author_id: 3, text: 'I enjoy twenty twenty twenty twenty nineteenth post' )
Comment.create(post: sixty_one, author_id: 3, text: 'I enjoy twenty twenty twenty twenty twentieth post' )
Comment.create(post: sixty_two, author_id: 3, text: 'I enjoy twenty twenty twenty twenty twenty first post' )
Comment.create(post: sixty_three, author_id: 3, text: 'I enjoy twenty twenty twenty twenty twenty second post' )
Comment.create(post: sixty_four, author_id: 4, text: 'I enjoy twenty twenty twenty twenty twenty third post' )
Comment.create(post: sixty_five, author_id: 4, text: 'I enjoy twenty twenty twenty twenty twenty fourth post' )
Comment.create(post: sixty_six, author_id: 4, text: 'I enjoy twenty twenty twenty twenty twenty fifth post' )
Comment.create(post: sixty_seven, author_id: 4, text: 'I enjoy twenty twenty twenty twenty twenty sixth post' )
Comment.create(post: sixty_eight, author_id: 4, text: 'I enjoy twenty twenty twenty twenty twenty seventh post' )
Comment.create(post: sixty_nine, author_id: 5, text: 'I enjoy twenty twenty twenty twenty twenty eighth post' )
Comment.create(post: seventy, author_id: 5, text: 'I enjoy twenty twenty twenty twenty twenty ninth post' )
Comment.create(post: seventy_one, author_id: 5, text: 'I enjoy twenty twenty twenty twenty twenty tenth post' )
Comment.create(post: first_post, author_id: 2, text: 'Great post' )
Comment.create(post: second_post, author_id: 2, text: 'Great post' )
Comment.create(post: first_post, author_id: 2, text: 'Great post' )
Comment.create(post: second_post, author_id: 2, text: 'Great post' )
Comment.create(post: first_post, author_id: 2, text: 'Great post' )
